import { PathWizard } from "./components/pathWizard.js";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    __main__.index.load('./index.json').then(() => {
        ...
        wpage.id = 'work__page';
        let browser_btn = document.createElement('img');
        ...
        window.addEventListener('hashchange', () => {
            ...
            if (nHash == '') {
                ...
                if (nHash.endsWith('/')) {
                    let fo = __main__.index.root.open(nHash);
                    if (fo !== undefined) {
                        wpage.innerHTML = '';
                    ...
                    let ao = __main__.index.root.get(nHash);
                    if (ao !== undefined) {
